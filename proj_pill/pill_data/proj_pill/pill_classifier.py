...
def run_model(args, model, dataloader_train, dataloader_valid, sampler_train, sampler_valid, criterion,optimizer, epoch_begin, log_writer, verbose=True  ):
    ...
    # verbose=True 부분을 지워줍니다.
    lr_scheduler = ReduceLROnPlateau(optimizer, mode='min', factor=0.8, patience=2, threshold=0.0001, threshold_mode='rel', cooldown=3, min_lr=0, eps=1e-08)
